...
public class FullPathFinder {
	...
	public static void main(String[] args) {
		...
		for (String path : paths) {
			for (AuditLog log : reports) {
				...
				if (reportName.equals(log.name.replace("(", "_").replace(")","_").replace(" ", "_")) && !result.contains(path + "____" + log.name + "____" + log.owner)) {
	...
	private static List<AuditLog> getReports() {
		...
		list.add(new AuditLog("1.2_Spends_SupercardMerchants", "chirag.ch@zeta.in", "2017-10-10 16:45"));
		list.add(new AuditLog("11_Payments_to_Merchants_Settlement_via_imps_etc_(zeta and collect call)_ISOParams",
				"chirag.ch@zeta.in", "2017-11-27 12:29"));
		list.add(new AuditLog("11_Payments_to_Merchants_Settlement_via_imps_etc_(zeta and collect call)_ISOParams",
				"chirag.ch@zeta.in", "2017-12-01 0:01"));
		...
		list.add(new AuditLog("2.4_Funding_Cardloads_corpusers", "chirag.ch@zeta.in", "2017-10-10 16:47"));
		list.add(new AuditLog("3.1_Clearing_ClearedTransactions_MasterCard", "chirag.ch@zeta.in", "2017-10-10 16:48"));
		list.add(new AuditLog("3.1_Clearing_ClearedTransactions_Rupay", "chirag.ch@zeta.in", "2017-10-16 12:22"));
		list.add(new AuditLog("3.2_Clearing_UnsettledTransactions", "chirag.ch@zeta.in", "2017-10-16 12:23"));
		...
		list.add(new AuditLog("7_Transfer_from_Voucher_to_CASH_on_Billupload_ISOParams", "chirag.ch@zeta.in",
				"2017-11-27 12:30"));
		list.add(new AuditLog("7_Transfer_from_Voucher_to_CASH_on_Billupload_ISOParams", "chirag.ch@zeta.in",
				"2017-12-01 0:01"));
		list.add(new AuditLog("8a_Payments_to_individuals_on_settlement_to_merchants_directly_from_wallet_ISOParams",
				"chirag.ch@zeta.in", "2017-11-27 12:30"));
		list.add(new AuditLog("8a_Payments_to_individuals_on_settlement_to_merchants_directly_from_wallet_ISOParams",
				"chirag.ch@zeta.in", "2017-12-01 0:00"));
		list.add(new AuditLog("8b_Payments_to_individuals_settlement_to_merchants_directly_from_wallet_ISOParams",
				"chirag.ch@zeta.in", "2017-11-27 12:30"));
		list.add(new AuditLog("8b_Payments_to_individuals_settlement_to_merchants_directly_from_wallet_ISOParams",
				"chirag.ch@zeta.in", "2017-12-01 0:00"));
		list.add(new AuditLog("9_Payment_to_Merchants_through_Individuals_ISOParams", "chirag.ch@zeta.in",
				"2017-12-01 0:00"));
		list.add(new AuditLog("Activation Report using CorpID", "chirag.ch@zeta.in", "2017-12-08 14:46"));
		list.add(new AuditLog("Activation_Report_Using_Domain_Name", "chirag.ch@zeta.in", "2017-12-08 12:30"));
		...
		list.add(new AuditLog("Add_Money_UPI_NetBanking_Card", "chirag.ch@zeta.in", "2017-11-07 10:33"));
		list.add(new AuditLog("AddressResolution_MissedUserEmails_Statement", "chirag.ch@zeta.in", "2017-10-09 7:35"));
		...
		list.add(new AuditLog("Cashless cafe Infinix Session Report - Dinner", "chirag.ch@zeta.in", "2017-12-04 7:31"));
		list.add(new AuditLog("Cashless cafe Infinix Session Report - Lunch", "chirag.ch@zeta.in", "2017-12-01 3:52"));
		list.add(new AuditLog("CashlessCafeteria_Corporate_Report", "chirag.ch@zeta.in", "2017-12-06 18:01"));
		list.add(new AuditLog("CashlessCafeteria_Vendor_Report", "chirag.ch@zeta.in", "2017-12-08 1:14"));
		...
		list.add(new AuditLog("Merchant Reconciliation Report", "chirag.ch@zeta.in", "2017-12-06 18:40"));
		...
		list.add(new AuditLog("PendingAndFailedPayoutsStatement", "chirag.ch@zeta.in", "2017-12-08 1:12"));
		list.add(new AuditLog("Physical Mastercard Supercard Users", "chirag.ch@zeta.in", "2017-12-06 14:17"));
		...
		list.add(new AuditLog("PrepaidRechargeReport_WithUsersPhoneNumber", "chirag.ch@zeta.in", "2017-12-08 0:00"));
		list.add(new AuditLog("Processed_Bills", "chirag.ch@zeta.in", "2017-12-08 4:00"));
		list.add(new AuditLog("Redcarpet_AllTransaction_Report", "chirag.ch@zeta.in", "2017-12-08 2:55"));
		list.add(new AuditLog("Redcarpet_User_Report", "chirag.ch@zeta.in", "2017-12-08 2:34"));
		list.add(new AuditLog("ReimbursementMasterCarMaintenance", "chirag.ch@zeta.in", "2017-11-28 12:45"));
		list.add(new AuditLog("RupaySpendsReport", "chirag.ch@zeta.in", "2017-12-08 0:00"));
		list.add(new AuditLog("Sales AreaManagers Contribution", "chirag.ch@zeta.in", "2017-12-07 3:00"));
		...
		list.add(new AuditLog("SpendsReportUsingCardprogramID", "chirag.ch@zeta.in", "2017-11-17 6:54"));
		list.add(new AuditLog("uncurated_but_Transacted_Stores", "chirag.ch@zeta.in", "2017-12-08 0:10"));
		...
		list.add(new AuditLog("UsersAddingMoneyToCashCardHighLevel", "chirag.ch@zeta.in", "2017-11-27 14:20"));
		...
		list.add(new AuditLog("ClosedCardPayoutStatement", "corpbenreportconsumer@zeta.tech", "2017-11-09 11:11"));
		list.add(new AuditLog("ClosedCardPayoutStatementTemp", "corpbenreportconsumer@zeta.tech", "2017-11-09 11:08"));
		...
		list.add(new AuditLog("AutomationTemplateMonthlyReport", "datascience-misc1", "2017-12-06 15:18"));
		...
		list.add(new AuditLog("ZetaBusinessMetricsLedgerBiller", "datascience-misc1", "2017-12-08 13:28"));
		...
		list.add(new AuditLog("2.4_Funding_Cardloads_corpusers", "gunjan@zeta.tech", "2017-10-23 10:06"));
		list.add(new AuditLog("2.4_Funding_Cardloads_corpusers", "gunjan@zeta.tech", "2017-10-25 13:56"));
		list.add(new AuditLog("3.1_Clearing_ClearedTransactions_Rupay", "gunjan@zeta.tech", "2017-12-08 10:29"));
		list.add(new AuditLog("3.2_Clearing_UnsettledTransactions", "gunjan@zeta.tech", "2017-12-08 10:29"));
		...
		list.add(new AuditLog("7.1_TransactionsAML_Kotak_daily", "gunjan@zeta.tech", "2017-11-22 18:13"));
		list.add(new AuditLog("8a_Payments_to_individuals_on_settlement_to_merchants_directly_from_wallet_ISOParams",
				"gunjan@zeta.tech", "2017-10-20 9:55"));
		list.add(new AuditLog("Activation_Report_Using_Domain_Name", "gunjan@zeta.tech", "2017-11-13 13:02"));
		list.add(new AuditLog("AddressResolution_MissedUserEmails_Statement", "gunjan@zeta.tech", "2017-12-08 10:29"));
		...
		list.add(new AuditLog("BusinessMetrics_forGivenPeriod", "gunjan@zeta.tech", "2017-10-20 11:40"));
		...
		list.add(new AuditLog("CardProgramAggregateFinancialsPerUser", "gunjan@zeta.tech", "2017-10-20 10:54"));
		list.add(new AuditLog("cardProgramSpends", "gunjan@zeta.tech", "2017-10-23 13:45"));
		list.add(new AuditLog("CardProgramSummaryReportSamsung", "gunjan@zeta.tech", "2017-11-01 9:00"));
		...
		list.add(new AuditLog("CashlessCafeteria_Corporate_Report", "gunjan@zeta.tech", "2017-11-27 5:20"));
		list.add(new AuditLog("CashlessCafeteria_Vendor_Report", "gunjan@zeta.tech", "2017-11-27 5:20"));
		list.add(new AuditLog("CashlessCafetriaReport_token", "gunjan@zeta.tech", "2017-11-27 5:21"));
		list.add(new AuditLog("CashlessCafteria_CorporateReport_WithProductParam", "gunjan@zeta.tech",
				"2017-10-20 12:14"));
		list.add(new AuditLog("ClosedCardwithCardIDs", "gunjan@zeta.tech", "2017-10-23 12:31"));
		list.add(new AuditLog("Corporate - Add Funds detailed report", "gunjan@zeta.tech", "2017-10-20 7:28"));
		...
		list.add(new AuditLog("DepositAndRevokeStatement_AllCardPrograms", "gunjan@zeta.tech", "2017-10-20 11:48"));
		...
		list.add(new AuditLog("Disbursed_Spent_Data_by_businessID", "gunjan@zeta.tech", "2017-11-10 12:05"));
		...
		list.add(new AuditLog("Kotak_PPI_Metrics_Table2_P2M_Split", "gunjan@zeta.tech", "2017-12-07 9:43"));
		...
		list.add(new AuditLog("MasterkeyReport_5Columns (Ledger DB)", "gunjan@zeta.tech", "2017-11-28 12:38"));
		list.add(new AuditLog("MasterkeyReport_5Columns (Reporting DWH DB)", "gunjan@zeta.tech", "2017-11-29 5:56"));
		list.add(new AuditLog("MerchantActivityMetrics_forGivenPeriod", "gunjan@zeta.tech", "2017-10-20 11:59"));
		list.add(new AuditLog("MerchantActivityMetrics_forGivenPeriod", "gunjan@zeta.tech", "2017-11-23 10:02"));
		...
		list.add(new AuditLog("MonthlyPPISummary_WithKycSplit_Part1", "gunjan@zeta.tech", "2017-12-01 12:00"));
		list.add(new AuditLog("MonthlyPPISummary_WithKycSplit_Part2", "gunjan@zeta.tech", "2017-12-01 12:10"));
		list.add(new AuditLog("NewUsersAdded", "gunjan@zeta.tech", "2017-11-10 12:01"));
		list.add(new AuditLog("PayoutsReportUsingCardprogramIDs", "gunjan@zeta.tech", "2017-11-01 9:01"));
		list.add(new AuditLog("PayoutsSummary", "gunjan@zeta.tech", "2017-12-08 1:25"));
		list.add(new AuditLog("PendingAndFailedPayoutsStatement", "gunjan@zeta.tech", "2017-12-08 1:30"));
		...
		list.add(new AuditLog("RBL_PPI_Metrics_OffUsMerchantLiability", "gunjan@zeta.tech", "2017-12-07 7:15"));
		list.add(new AuditLog("RBL_PPI_Metrics_OnUsMerchantLiability", "gunjan@zeta.tech", "2017-12-07 6:52"));
		list.add(new AuditLog("RBL_PPI_Metrics_Table2_P2M_Split", "gunjan@zeta.tech", "2017-12-07 10:15"));
		...
		list.add(new AuditLog("Redcarpet_AllTransaction_Report", "gunjan@zeta.tech", "2017-11-23 10:04"));
		...
		list.add(new AuditLog("SpendsReportwithTransactionType", "gunjan@zeta.tech", "2017-10-24 16:25"));
		...
		list.add(new AuditLog("User_Entity_Getting_Stale_Alert", "gunjan@zeta.tech", "2017-12-08 14:30"));
		list.add(new AuditLog("User_Matrix", "gunjan@zeta.tech", "2017-11-23 10:07"));
		list.add(new AuditLog("Users Spending Atleast Once from Cardprogram", "gunjan@zeta.tech", "2017-10-23 7:44"));
		...
		list.add(new AuditLog("CashlessCafeteria_Corporate_Report", "indumathiv@zeta.tech", "2017-12-06 14:23"));
		list.add(new AuditLog("CashlessCafeteria_Vendor_Report", "indumathiv@zeta.tech", "2017-11-14 11:46"));
		list.add(new AuditLog("CashlessCafetriaReport_token", "indumathiv@zeta.tech", "2017-11-14 12:12"));
		list.add(new AuditLog("EliorZetaPaymentCiscoBreakfast", "indumathiv@zeta.tech", "2017-11-21 11:06"));
		list.add(new AuditLog("EliorZetaPaymentCiscoSnacks", "indumathiv@zeta.tech", "2017-11-21 11:05"));
		...
		list.add(new AuditLog("8d_Funds_into_CashCard_via_Gateway_ISOParams", "jasperadmin", "2017-12-01 5:33"));
		list.add(
				new AuditLog("9_Payment_to_Merchants_through_Individuals_ISOParams", "jasperadmin", "2017-12-01 4:00"));
		list.add(new AuditLog("AccenturePayoutTransactionNull", "jasperadmin", "2017-11-03 11:27"));
		list.add(new AuditLog("Activation_Report_Using_Domain_Name", "jasperadmin", "2017-10-11 19:05"));
		...
		list.add(new AuditLog("New Users Current Month - Daily Report", "jasperadmin", "2017-10-30 9:07"));
		...
		list.add(new AuditLog("Users Spending Atleast Once from Cardprogram", "jasperadmin", "2017-10-25 5:07"));
		...
		list.add(new AuditLog("CardProgramSummaryReportSamsung", "jindal@zeta.tech", "2017-11-09 17:06"));
		list.add(new AuditLog("CardProgramSummaryReportSamsung", "jindal@zeta.tech", "2017-12-05 6:40"));
		...
		list.add(new AuditLog("ClosedCardwithCardIDsforAllowanceProducts", "jindal@zeta.tech", "2017-11-17 6:25"));
		list.add(new AuditLog("ClosedCardwithCardIDsforAllowanceProducts", "jindal@zeta.tech", "2017-12-07 12:27"));
		...
		list.add(new AuditLog("PayoutsReportUsingCardprogramIDs", "jindal@zeta.tech", "2017-11-15 9:33"));
		list.add(new AuditLog("PayoutsReportUsingCardprogramIDs", "jindal@zeta.tech", "2017-12-01 10:05"));
		list.add(new AuditLog("ReimbursementMasterCarMaintenance", "jindal@zeta.tech", "2017-11-15 15:20"));
		list.add(new AuditLog("ReimbursementMasterCarMaintenance", "jindal@zeta.tech", "2017-11-30 9:16"));
		...
		list.add(new AuditLog("SpendsReportUsingCardprogramID", "jindal@zeta.tech", "2017-12-01 10:03"));
		list.add(new AuditLog("11_Payments_to_Merchants_Settlement_via_imps_etc_(zeta and collect call)_ISOParams",
				"madhav.g@zeta.tech", "2017-10-11 14:02"));
		list.add(new AuditLog("11_Payments_to_Merchants_Settlement_via_imps_etc_(zeta and collect call)_ISOParams",
				"madhav.g@zeta.tech", "2017-12-01 5:35"));
		list.add(new AuditLog("4.1_Summary_balance_report", "madhav.g@zeta.tech", "2017-12-05 7:05"));
		list.add(new AuditLog("7_Transfer_from_Voucher_to_CASH_on_Billupload_ISOParams", "madhav.g@zeta.tech",
				"2017-10-09 7:11"));
		list.add(new AuditLog("7_Transfer_from_Voucher_to_CASH_on_Billupload_ISOParams", "madhav.g@zeta.tech",
				"2017-12-01 4:00"));
		list.add(new AuditLog("8a_Payments_to_individuals_on_settlement_to_merchants_directly_from_wallet_ISOParams",
				"madhav.g@zeta.tech", "2017-12-01 3:00"));
		list.add(new AuditLog("8b_Payments_to_individuals_settlement_to_merchants_directly_from_wallet_ISOParams",
				"madhav.g@zeta.tech", "2017-11-08 14:31"));
		list.add(new AuditLog("8b_Payments_to_individuals_settlement_to_merchants_directly_from_wallet_ISOParams",
				"madhav.g@zeta.tech", "2017-12-01 3:00"));
		list.add(new AuditLog("8c_Imps_NEFT_in_CashCard", "madhav.g@zeta.tech", "2017-12-01 5:35"));
		list.add(
				new AuditLog("8d_Funds_into_CashCard_via_Gateway_ISOParams", "madhav.g@zeta.tech", "2017-11-13 10:52"));
		list.add(new AuditLog("9_Payment_to_Merchants_through_Individuals_ISOParams", "madhav.g@zeta.tech",
				"2017-11-13 9:28"));
		list.add(new AuditLog("9_Payment_to_Merchants_through_Individuals_ISOParams", "madhav.g@zeta.tech",
				"2017-11-13 15:36"));
		list.add(new AuditLog("AccentureMerchantTransactionType", "madhav.g@zeta.tech", "2017-11-03 16:00"));
		list.add(new AuditLog("AccenturePayoutTransactionNull", "madhav.g@zeta.tech", "2017-11-03 15:49"));
		list.add(new AuditLog("Activation Report using CorpID", "madhav.g@zeta.tech", "2017-10-27 14:07"));
		list.add(new AuditLog("Activation_Report_Using_Domain_Name", "madhav.g@zeta.tech", "2017-12-08 1:30"));
		...
		list.add(new AuditLog("AutomationTemplateMonthlyReport", "madhav.g@zeta.tech", "2017-12-06 15:18"));
		...
		list.add(new AuditLog("CardProgramSummaryReportSamsung", "madhav.g@zeta.tech", "2017-11-24 8:57"));
		list.add(new AuditLog("CardProgramSummaryReportSamsung", "madhav.g@zeta.tech", "2017-11-24 9:05"));
		list.add(new AuditLog("CardProgramYearEndReport", "madhav.g@zeta.tech", "2017-11-17 9:23"));
		list.add(new AuditLog("CashlessCafeteria_Corporate_Report", "madhav.g@zeta.tech", "2017-10-26 11:28"));
		list.add(new AuditLog("CashlessCafeteria_Vendor_Report", "madhav.g@zeta.tech", "2017-10-26 11:20"));
		...
		list.add(new AuditLog("ClosedCardwithCardIDsforAllowanceProducts", "madhav.g@zeta.tech", "2017-11-17 10:04"));
		list.add(new AuditLog("ClosedCardwithCardIDsforAllowanceProducts", "madhav.g@zeta.tech", "2017-11-23 12:07"));
		list.add(new AuditLog("CorpBen_IMV_Payouts", "madhav.g@zeta.tech", "2017-11-06 12:34"));
		list.add(new AuditLog("Corporate Order Report - Monthly", "madhav.g@zeta.tech", "2017-12-01 0:01"));
		list.add(new AuditLog("Corporate Sign Up Request - Daily", "madhav.g@zeta.tech", "2017-12-08 14:00"));
		list.add(new AuditLog("CorporateCardTypeTransactionsData", "madhav.g@zeta.tech", "2017-11-19 11:05"));
		...
		list.add(new AuditLog("EliorNonZetaPaymentCiscoBreakfast", "madhav.g@zeta.tech", "2017-12-08 10:30"));
		list.add(new AuditLog("EliorNonZetaPaymentCiscoDinner", "madhav.g@zeta.tech", "2017-12-08 1:30"));
		list.add(new AuditLog("EliorNonZetaPaymentCiscoLunch", "madhav.g@zeta.tech", "2017-12-08 10:33"));
		list.add(new AuditLog("EliorNonZetaPaymentCiscoSnacks", "madhav.g@zeta.tech", "2017-12-07 15:30"));
		list.add(new AuditLog("EliorZetaPaymentCiscoBreakfast", "madhav.g@zeta.tech", "2017-12-08 10:30"));
		...
		list.add(new AuditLog("Fund Request Summary- Daily Report", "madhav.g@zeta.tech", "2017-12-07 16:00"));
		...
		list.add(new AuditLog("GlobalItemLevelCiscoMerchantEvening", "madhav.g@zeta.tech", "2017-12-07 15:00"));
		list.add(new AuditLog("GlobalItemLevelCiscoMerchantMorning", "madhav.g@zeta.tech", "2017-12-08 0:30"));
		list.add(new AuditLog("GlobalNonZetaPaymentCiscoEvening", "madhav.g@zeta.tech", "2017-12-07 15:00"));
		list.add(new AuditLog("GlobalNonZetaPaymentCiscoMorning", "madhav.g@zeta.tech", "2017-12-08 0:30"));
		list.add(new AuditLog("GlobalZetaPaymentCiscoEvening", "madhav.g@zeta.tech", "2017-12-07 15:00"));
		list.add(new AuditLog("GlobalZetaPaymentCiscoMorning", "madhav.g@zeta.tech", "2017-12-08 0:30"));
		...
		list.add(new AuditLog("InterchangeEarnedAfterRefunds", "madhav.g@zeta.tech", "2017-11-06 11:57"));
		list.add(new AuditLog("InterchangeEarnedPerProductTypeHighLevel", "madhav.g@zeta.tech", "2017-11-01 20:21"));
		list.add(new AuditLog("Invoices", "madhav.g@zeta.tech", "2017-11-22 15:45"));
		list.add(new AuditLog("ItemLevelCiscoMerchantMidnight", "madhav.g@zeta.tech", "2017-11-11 12:33"));
		list.add(new AuditLog("ItemLevelReportCiscoMerchantEvening", "madhav.g@zeta.tech", "2017-11-11 12:33"));
		list.add(new AuditLog("Meal Voucher Spend Report Jewelex", "madhav.g@zeta.tech", "2017-12-05 14:01"));
		list.add(new AuditLog("New Users Current Month - Daily Report", "madhav.g@zeta.tech", "2017-10-30 8:15"));
		...
		list.add(new AuditLog("NewUsersAddedMonthlyReport - NonSodexo", "madhav.g@zeta.tech", "2017-12-01 4:40"));
		list.add(new AuditLog("NewUsersAddedMonthlyReport - Sodexo", "madhav.g@zeta.tech", "2017-12-01 4:40"));
		list.add(new AuditLog("NewUsersMonthtillDate_Daily Report", "madhav.g@zeta.tech", "2017-10-12 13:25"));
		list.add(new AuditLog("NewUsersMonthtillDate_Daily Report - NonSodexo", "madhav.g@zeta.tech",
				"2017-12-08 3:30"));
		list.add(new AuditLog("NewUsersMonthtillDate_Daily Report - Sodexo", "madhav.g@zeta.tech", "2017-12-08 3:30"));
		...
		list.add(new AuditLog("NonZetaPaymentCiscoBreakfast", "madhav.g@zeta.tech", "2017-11-11 12:34"));
		...
		list.add(new AuditLog("Orders Completed Last Month - Daily Report", "madhav.g@zeta.tech", "2017-12-07 16:00"));
		list.add(new AuditLog("PayoutPerCardProgramPerMonthYear", "madhav.g@zeta.tech", "2017-11-29 14:01"));
		list.add(new AuditLog("Payouts", "madhav.g@zeta.tech", "2017-11-17 9:17"));
		list.add(new AuditLog("PayoutsReportUsingCardprogramIDs", "madhav.g@zeta.tech", "2017-10-26 14:05"));
		list.add(new AuditLog("PayoutsReportUsingCardprogramIDs", "madhav.g@zeta.tech", "2017-11-17 9:16"));
		list.add(new AuditLog("ProductWiseSpendMonthHighLevel", "madhav.g@zeta.tech", "2017-11-06 12:26"));
		list.add(new AuditLog("QuickshopDB test report", "madhav.g@zeta.tech", "2017-10-13 14:02"));
		list.add(new AuditLog("ReimbursementMasterCarMaintenance", "madhav.g@zeta.tech", "2017-11-08 15:17"));
		...
		list.add(new AuditLog("ReimbursementMasterReportNew", "madhav.g@zeta.tech", "2017-11-27 14:12"));
		...
		list.add(new AuditLog("SpendReportWithVerifiedEmails", "madhav.g@zeta.tech", "2017-10-17 13:37"));
		list.add(new AuditLog("SpendsReportUsingCardprogramID", "madhav.g@zeta.tech", "2017-11-24 9:04"));
		list.add(new AuditLog("SpendsReportUsingCardprogramID", "madhav.g@zeta.tech", "2017-12-06 7:42"));
		list.add(new AuditLog("SpendsReportUsingCardprogramIDSamsung", "madhav.g@zeta.tech", "2017-10-31 10:54"));
		list.add(new AuditLog("SpendsReportWithoutVerifiedEmails", "madhav.g@zeta.tech", "2017-10-17 12:36"));
		list.add(new AuditLog("SpendsReportwithTransactionType", "madhav.g@zeta.tech", "2017-12-05 11:14"));
		...
		list.add(new AuditLog("Unique Users - Monthly Report", "madhav.g@zeta.tech", "2017-12-01 6:00"));
		list.add(
				new AuditLog("Users Spending Atleast Once from Cardprogram", "madhav.g@zeta.tech", "2017-10-18 11:00"));
		list.add(
				new AuditLog("Users Spending Atleast Once from Cardprogram", "madhav.g@zeta.tech", "2017-12-08 10:30"));
		list.add(new AuditLog("UsersAddingMoneyToCashCardHighLevel", "madhav.g@zeta.tech", "2017-11-01 19:16"));
		list.add(new AuditLog("UserSummary", "madhav.g@zeta.tech", "2017-10-16 14:15"));
		list.add(new AuditLog("UsersWithdrawingtoBankHighLevel", "madhav.g@zeta.tech", "2017-10-31 13:20"));
		list.add(new AuditLog("ZetaBusinessMetrics", "madhav.g@zeta.tech", "2017-12-08 9:27"));
		list.add(new AuditLog("ZetaBusinessMetricsLedgerBiller", "madhav.g@zeta.tech", "2017-12-08 14:01"));
		...
		list.add(new AuditLog("CardProgramSummaryReportSamsung", "manish.shu@zeta.tech", "2017-11-01 13:12"));
		...
		list.add(new AuditLog("ClosedCardPayoutStatementTemp", "manish.shu@zeta.tech", "2017-10-25 10:02"));
		list.add(new AuditLog("ClosedCardStatusByOrderID", "manish.shu@zeta.tech", "2017-11-17 6:07"));
		list.add(new AuditLog("ClosedCardwithCardIDsforAllowanceProducts", "manish.shu@zeta.tech", "2017-10-27 17:43"));
		list.add(new AuditLog("ClosedCardwithCardIDsforAllowanceProducts", "manish.shu@zeta.tech", "2017-11-17 11:46"));
		list.add(new AuditLog("FundingAccountFundMovement", "manish.shu@zeta.tech", "2017-10-30 8:36"));
		list.add(new AuditLog("FundingAccountTransferDetail", "manish.shu@zeta.tech", "2017-10-30 8:37"));
		list.add(new AuditLog("MerchantActivity_Each", "manish.shu@zeta.tech", "2017-10-23 13:34"));
		list.add(new AuditLog("PayoutsReportUsingCardprogramIDs", "manish.shu@zeta.tech", "2017-11-17 9:51"));
		list.add(new AuditLog("PayoutsReportUsingCardprogramIDs", "manish.shu@zeta.tech", "2017-11-17 9:56"));
		list.add(new AuditLog("ReimbursementMasterCarMaintenance", "manish.shu@zeta.tech", "2017-11-13 11:32"));
		list.add(new AuditLog("ReimbursementMasterCarMaintenance", "manish.shu@zeta.tech", "2017-11-28 11:58"));
		...
		list.add(new AuditLog("ReimbursementMasterReportNew", "manish.shu@zeta.tech", "2017-11-28 13:48"));
		list.add(new AuditLog("SpendsReportUsingCardprogramID", "manish.shu@zeta.tech", "2017-11-17 7:10"));
		list.add(new AuditLog("SpendsReportUsingCardprogramID", "manish.shu@zeta.tech", "2017-11-17 9:58"));
		list.add(new AuditLog("CashlessCafeteria_Corporate_Report", "rohil.g@zeta.in", "2017-12-08 1:10"));
		list.add(new AuditLog("Fresh_Settlements", "rohil.g@zeta.in", "2017-12-08 10:29"));
		list.add(new AuditLog("PendingAndFailedPayoutsStatement", "rohil.g@zeta.in", "2017-12-08 4:59"));
		list.add(new AuditLog("Report_CorpBen_CorpOrderSummary_AttributionData_TillDate", "rohil.g@zeta.in",
				"2017-12-08 2:30"));
		list.add(new AuditLog("Report_CorpBen_Payout_withStatus_Scheduled_ISOParams", "rohil.g@zeta.in",
				"2017-12-08 2:30"));
		...
		list.add(new AuditLog("1_onus_unsettled_kotak(temp)", "thumbnil.b@zeta.tech", "2017-11-30 12:20"));
		...
		list.add(new AuditLog("1.2_Spends_SupercardMerchants", "thumbnil.b@zeta.tech", "2017-11-22 8:46"));
		...
		list.add(new AuditLog("2.2_Funding_CorpOpsFundLoad", "thumbnil.b@zeta.tech", "2017-10-26 7:48"));
		list.add(new AuditLog("2.3_Funding_CorpIMPS-IN", "thumbnil.b@zeta.tech", "2017-10-26 7:49"));
		list.add(new AuditLog("2.4_Funding_Cardloads_corpusers", "thumbnil.b@zeta.tech", "2017-12-08 1:10"));
		list.add(new AuditLog("3.1_Clearing_ClearedTransactions_Rupay", "thumbnil.b@zeta.tech", "2017-12-08 1:10"));
		list.add(new AuditLog("3.2_Clearing_UnsettledTransactions", "thumbnil.b@zeta.tech", "2017-12-08 1:12"));
		list.add(new AuditLog("4.1_Summary_balance_report", "thumbnil.b@zeta.tech", "2017-12-08 10:29"));
		...
		list.add(new AuditLog("5.3_Corporate_BalanceReport", "thumbnil.b@zeta.tech", "2017-12-08 1:20"));
		...
		list.add(new AuditLog("ClosedCardPayoutStatementTemp", "thumbnil.b@zeta.tech", "2017-10-25 10:01"));
		list.add(new AuditLog("CountUsers_balmorethan1lac", "thumbnil.b@zeta.tech", "2017-12-08 14:06"));
		...
		list.add(new AuditLog("Kotak_Merchant_Settlements", "thumbnil.b@zeta.tech", "2017-11-03 11:15"));
		...
		list.add(new AuditLog("MasterkeyReport_5Columns_Ledger", "thumbnil.b@zeta.tech", "2017-11-27 7:53"));
		list.add(new AuditLog("MasterkeyReport_5Columns_Reporting", "thumbnil.b@zeta.tech", "2017-11-27 7:48"));
		...
		list.add(new AuditLog("SpendsReportwithTransactionType", "thumbnil.b@zeta.tech", "2017-10-20 10:47"));
		...
		list.add(new AuditLog("Volume_Value_ofSupercard_637513", "thumbnil.b@zeta.tech", "2017-12-08 10:30"));
	...
	private static List<String> getPaths() {
		...
		list.add("/Reports/prod/Audit/Nov16_Corp_Ledger_Reconciliation/CorpBen_AllPayouts_Practo_Asset");
		list.add("/Reports/prod/Audit/Nov16_Corp_Ledger_Reconciliation/CorpBen_AllPayouts_Practo_Meal");
		list.add("/Reports/prod/Audit/Nov16_Corp_Ledger_Reconciliation/CorpBen_AllPayouts_Practo_Medical");
		list.add("/Reports/prod/Audit/Nov16_Corp_Ledger_Reconciliation/CorpBen_AllPayouts_WarRoom_Recent");
		list.add("/Reports/prod/Audit/Nov16_Corp_Ledger_Reconciliation/Issuance_Details_Ledger_WarRoom");
		...
		list.add("/Reports/prod/Audit/Nov16_Corp_Ledger_Reconciliation/Ledger_AllPayouts_Practo_Medical");
		list.add("/Reports/prod/Audit/Nov16_Corp_Ledger_Reconciliation/Ledger_AllPayouts_WarRoom_Recent");
		...
		list.add("/Reports/prod/Corp_Benefits/MealMoney/On_Request_Reports/ClosedCardPayoutStatementTemp");
		list.add("/Reports/prod/Corp_Benefits/MealMoney/On_Request_Reports/ClosedCardStatusByOrderID");
		list.add("/Reports/prod/Corp_Benefits/MealMoney/On_Request_Reports/CorpBen_AllPayoutsOfGivenCompany");
		list.add("/Reports/prod/Corp_Benefits/MealMoney/On_Request_Reports/CorpBen_AreaSalesMangerDetails");
		list.add("/Reports/prod/Corp_Benefits/MealMoney/On_Request_Reports/CorpBen_AttributionData_ISOParam");
		list.add(
		...
		list.add("/Reports/prod/Corp_Benefits/MealMoney/On_Request_Reports/CorpBen_OrderPlacedYesNo_Report");
		...
		list.add("/Reports/prod/Corp_Benefits/MealMoney/On_Request_Reports/Report_CorpBen_Payout_withStatus_Scheduled");
		list.add(
		...
		list.add("/Reports/prod/Corp_Benefits/MealMoney/Weekly_Reports/Corporate_Order_Report___Monthly");
		...
		list.add("/Reports/prod/Corp_Benefits/MealMoney/Weekly_Reports/NewUsersAddedMonthlyReport___NonSodexo");
		list.add("/Reports/prod/Corp_Benefits/MealMoney/Weekly_Reports/NewUsersAddedMonthlyReport___Sodexo");
		list.add("/Reports/prod/Corp_Benefits/MealMoney/Weekly_Reports/NewUsersMonthtillDate_Daily_Report");
		list.add("/Reports/prod/Corp_Benefits/MealMoney/Weekly_Reports/NewUsersMonthtillDate_Daily_Report___NonSodexo");
		list.add("/Reports/prod/Corp_Benefits/MealMoney/Weekly_Reports/NewUsersMonthtillDate_Daily_Report___Sodexo");
		...
		list.add("/Reports/prod/Corp_Benefits/MealMoney/Weekly_Reports/PendingAndFailedPayoutsStatement");
		list.add(
				"/Reports/prod/Corp_Benefits/MealMoney/Weekly_Reports/Post_Sales_Reports/Corporate_Sign_Up_Request___Daily");
		list.add("/Reports/prod/Corp_Benefits/MealMoney/Weekly_Reports/Post_Sales_Reports/Daily_Order_Summary_Report");
		list.add(
		...
		list.add("/Reports/prod/Corp_Benefits/MealMoney/Weekly_Reports/Report_CorpBen_Payout_withStatus_Scheduled");
		list.add("/Reports/prod/Corp_Benefits/MealMoney/Weekly_Reports/Sales_AreaManagers_Contribution_");
		...
		list.add("/Reports/prod/Corp_Benefits/ReportingDB/Users_Spending_Atleast_Once_from_Cardprogram");
		...
		list.add("/Reports/prod/Ledger/Accounts/7_Transfer_from_Voucher_to_CASH_on_Billupload_ISOParams");
		list.add(
		...
		list.add("/Reports/prod/Ledger/CardProgram/ReportsByPrevNDays/DepositAndRevokeStatement_AllCardPrograms");
		list.add("/Reports/prod/Ledger/CardProgram/ReportsByPrevNDays/DetailedProgramStatement_1");
		list.add("/Reports/prod/Ledger/CardProgram/ReportsByPrevNDays/MerchantActivityMetrics_forGivenPeriod");
		list.add("/Reports/prod/Ledger/CardProgram/ReportsByPrevNDays/ReconciliationCheckForAllCorporates");
		...
		list.add("/Reports/prod/Ledger/CardProgram/ReportsByStartAndEndDates/BusinessMetrics_forGivenPeriod");
		...
		list.add("/Reports/prod/Ledger/CardProgram/ReportsByStartAndEndDates/MerchantActivityMetrics_forGivenPeriod");
		...
		list.add("/Reports/prod/merchant_settlements/Archive/Report_1st_Backlog_Settlement_1_PM_Updated");
		list.add("/Reports/prod/merchant_settlements/Archive/Report_2nd_Backlog_Settlement_4_PM_Updated");
		list.add("/Reports/prod/merchant_settlements/Archive/Report_3rd_Backlog_Settlement_7_PM_Updated");
		list.add("/Reports/prod/merchant_settlements/Archive/Report_Fresh_Settlements_Daily_Updated");
		list.add("/Reports/prod/merchant_settlements/Archive/Report_Unsettled_Transactions_2daysback_8_AM_Updated");
		list.add("/Reports/prod/merchant_settlements/Archive/Report_Unsettled_Transactions_3daysback_8_AM_Updated");
		...
		list.add("/Reports/prod/merchant_settlements/CiscoExpressSettlement/Elior/EliorNonZetaPaymentCiscoBreakfast");
		list.add("/Reports/prod/merchant_settlements/CiscoExpressSettlement/Elior/EliorNonZetaPaymentCiscoDinner");
		list.add("/Reports/prod/merchant_settlements/CiscoExpressSettlement/Elior/EliorNonZetaPaymentCiscoLunch");
		list.add("/Reports/prod/merchant_settlements/CiscoExpressSettlement/Elior/EliorNonZetaPaymentCiscoSnacks");
		list.add("/Reports/prod/merchant_settlements/CiscoExpressSettlement/Elior/EliorZetaPaymentCiscoBreakfast");
		list.add("/Reports/prod/merchant_settlements/CiscoExpressSettlement/Elior/EliorZetaPaymentCiscoDinner");
		list.add("/Reports/prod/merchant_settlements/CiscoExpressSettlement/Elior/EliorZetaPaymentCiscoLunch");
		list.add("/Reports/prod/merchant_settlements/CiscoExpressSettlement/Elior/EliorZetaPaymentCiscoSnacks");
		list.add("/Reports/prod/merchant_settlements/CiscoExpressSettlement/Elior/NonZetaMonthlyStatement");
		list.add("/Reports/prod/merchant_settlements/CiscoExpressSettlement/Elior/ZetaMonthlyStatement");
		list.add(
		...
		list.add("/Reports/prod/merchant_settlements/CiscoExpressSettlement/Global/GlobalNonZetaPaymentCiscoEvening");
		list.add("/Reports/prod/merchant_settlements/CiscoExpressSettlement/Global/GlobalNonZetaPaymentCiscoMorning");
		list.add("/Reports/prod/merchant_settlements/CiscoExpressSettlement/Global/GlobalZetaPaymentCiscoEvening");
		list.add("/Reports/prod/merchant_settlements/CiscoExpressSettlement/Global/GlobalZetaPaymentCiscoMorning");
		list.add("/Reports/prod/merchant_settlements/CiscoExpressSettlement/Global/NonZetaMonthlyStatement");
		list.add("/Reports/prod/merchant_settlements/CiscoExpressSettlement/Global/ZetaMonthlyStatement");
		list.add("/Reports/prod/merchant_settlements/CiscoExpressSettlement/ItemLevelCiscoMerchantMidnight");
		list.add("/Reports/prod/merchant_settlements/CiscoExpressSettlement/ItemLevelReportCiscoMerchantEvening");
		list.add("/Reports/prod/merchant_settlements/CiscoExpressSettlement/NonZetaPaymentCiscoBreakfast");
		...
		list.add("/Reports/prod/ReportCenter/prod/biller/CardProgram/ReimbursementMasterCarMaintenance");
		...
		list.add("/Reports/prod/ReportCenter/prod/Corp_Benefits/FundingAccount/FundingAccountFundMovement");
		list.add("/Reports/prod/ReportCenter/prod/Corp_Benefits/FundingAccount/FundingAccountTransferDetail");
		...
		list.add("/Reports/prod/ReportCenter/prod/Corp_Benefits/ReportingDB/ClosedCardwithCardIDsforAllowanceProducts");
