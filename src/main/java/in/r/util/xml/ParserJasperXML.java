...
public class ParserJasperXML {
  ...
  public static void main(String[] args) throws XMLStreamException, IOException {
    ...
    Resources resources =
        objectMapper.readValue(
            new FileInputStream("/Users/rahil.r/test1.xml"), Resources.class);
    resources
        .getReportUnitURI()
        .stream()
  ...
  public static class Resources {
    @Getter
    @JacksonXmlProperty(localName = "resourceDescriptor") List<ReportUnitURI> reportUnitURI;
